# ALTERNATE PROCESSING AND CLEANING SCRIPT IF THE FIRST ONE DOES NOT RUN. 
...
ed_new <- select(ed,ï..FIPS.Code,Percent.of.adults.with.a.bachelor.s.degree.or.higher..1990)
...
unemployment_new <- select(unemployment,ï..FIPS_Code, Unemployment_rate_2020, Median_Household_Income_2019)
...
glimpse(poverty)
poverty_new <- select(poverty,ï..FIPStxt, PCTPOVALL_2019)
