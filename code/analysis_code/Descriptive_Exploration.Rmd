...
p3 <- complete %>% ggplot(aes(x=pct_poverty, y=pct_vax)) + geom_point(color="green", size=.5) + geom_smooth(method='lm', color="black") +   xlim(0, 100) + ylim(0,100) +  coord_fixed() +
