...
The following RMD runs exploratory linear models on the processed dataset and calculates performance statistics for each. We first run a full model with all variables and a simple model with each variable and the outcome. 
```{r}
# MODELING SCRIPT
...
library(workflowr) #creating workflows
...
# saved it as a file
lm1= here::here("results", "lm_fit_table.rds")
saveRDS(lm_fit_table, file = lm1)
...
# saved it as a file
lm1stat = here::here("results", "lm_fit_stats.rds")
saveRDS(lm_fit_stats, file = lm1stat)
...
# saved it as a file
summarytable_file3 = here::here("results", "lm_fit_table2.rds")
...
# saved it as a file
summarytable_file4 = here::here("results", "lm_fit_stats2.rds")
...
# saved it as a file
summarytable_file4 = here::here("results", "lm_fit_median.rds")
...
# saved it as a file
summarytable_file5 = here::here("results", "lm_fit_poverty.rds")
...
# saved it as a file
summarytable_file6 = here::here("results", "lm_fit_unemployment.rds")
...
# saved it as a file
summarytable_file7 = here::here("results", "lm_fit_locality.rds")
